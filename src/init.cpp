    ...
    try
    {
        ...
        if (mapArgs.count("-?") || mapArgs.count("--help"))
        {
            ...
            std::string strUsage = _("FooCoin version") + " " + FormatFullVersion() + "\n\n" +
                _("Usage:") + "\n" +
                  "  evencoin [options]                     " + "\n" +
                  "  evencoin [options] <command> [params]  " + _("Send command to -server or evencoin") + "\n" +
                  "  evencoin [options] help                " + _("List commands") + "\n" +
                  "  evencoin [options] help <command>      " + _("Get help for a command") + "\n";
        ...
        for (int i = 1; i < argc; i++)
            if (!IsSwitchChar(argv[i][0]) && !boost::algorithm::istarts_with(argv[i], "evencoin:"))
                fCommandLine = true;
...
std::string HelpMessage()
{
    string strUsage = _("Options:") + "\n" +
        "  -conf=<file>           " + _("Specify configuration file (default: evencoin.conf)") + "\n" +
        "  -pid=<file>            " + _("Specify pid file (default: evencoin.pid)") + "\n" +
...
//    }
    ...
    // Make sure only a single evencoin process is using the data directory.
    ...
    // requested to kill evencoin-qt during the last operation. If so, exit.
