...
{
    boost::filesystem::path pathConfigFile(GetArg("-conf", "evencoin.conf"));
                    ...
                    map<string, vector<string> >& mapMultiSettingsRet)
{
    ...
    if (!streamConfig.good())
        return; // No evencoin.conf file is OK
    ...
    {
        // Don't overwrite existing settings so command line settings override evencoin.conf
...
{
    boost::filesystem::path pathPidFile(GetArg("-pid", "evencoin.pid"));
